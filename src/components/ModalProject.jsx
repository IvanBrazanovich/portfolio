...
const ModalProject = ({ item }) => {
  return (
    <div className="box flex flex-col max-h-full overflow-y-auto overflow-x-hidden  py-5 px-12 rounded-lg justify-between  items-center bg-[#171717] ">
      ...
      <img src={item.img} className="max-w-2xl" />
      <div className="info flex flex-col text-white">
